...
- **A consistent but undocumented extension** used across 6 reference/tracking-style docs, never added to the §2 enum: `reference only` on [DevOps — Future Considerations](/devops/future-considerations.md), [Engineering — Future Considerations](/engineering/future-considerations.md), [Product — Future Considerations](/product/future-considerations.md), and [Testing Strategy](/qa/testing-strategy.md); `living document` on [Open Questions](/open-questions.md) (this doc) and [MVP Scope Gaps](/product/mvp-scope-gaps.md).
