...
Broken into sub-documents because of its scope — distinct search, loading, results, action, and error states, each specified separately in [Searching the OMDb to Add a Movie](/product/user-journeys/searching-omdb.md). All sub-screens are now confirmed.
...
* ✅ [No Results & Errors](/design/screens/omdb-search/no-results-and-errors.md) - No-results and error state design.
