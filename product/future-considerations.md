...
- Migrate from the OMDb API to [The Movie Database (TMDB)](https://www.themoviedb.org/?language=en-GB) — TMDB offers a more feature-rich API (richer metadata, images/artwork, trending/discovery endpoints) than OMDb. MVP ships on OMDb; see [OMDb API Reference](/engineering/omdb-api-reference.md).
